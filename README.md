# `haddock-runner` for [HADDOCK](https://www.github.com/haddocking/haddock3)
...
`haddock-runner` is a tool for running large-scale HADDOCK docking experiments.

## Installation / Usage / Examples

Read the docs at [bonvinlab.org/haddock-runner](https://bonvinlab.org/haddock-runner)

## Citation

If you use this tool in your research please cite: _pending_
